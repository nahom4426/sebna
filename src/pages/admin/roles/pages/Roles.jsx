    ...
    <tr key={row.id || index} className="border-b border-gray-200 hover:bg-gray-50">
      ...
      <td className="px-1.5 sm:px-2 py-1.5 text-[10px] sm:text-xs">
        <div className="flex gap-2">
          <button 
            onClick={() => navigate(`/admin/roles/edit/${row.roleUuid}`)}
      ...
      <div className="mb-6">
        <div className="flex justify-between items-center mb-4">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-900 to-orange-600 text-white font-semibold rounded-lg hover:shadow-lg transition-all duration-300"
          >
            <svg
              className="w-5 h-5"
              fill="none"
